...
public class HalJsonResourceTest {
    ...
    public void testGetFirstLinkNoLinksAtAll() {
        HalJsonResource resource = new HalJsonResource(root);
        resource.getFirstMatchingLink("x", "*");

    }

    @Test(expected = HyperResourceException.class)
    public void testGetFirstLinkNoLinksEntry() {
        root.remove("_links");
        HalJsonResource resource = new HalJsonResource(root);
        resource.getFirstMatchingLink("x", "*");
    ...
    @Test(expected = HyperResourceException.class)
    public void testGetFirstLinkNoLinksInRel() {
        ArrayNode linkArray = nodeFactory.arrayNode();
        String rel = "bb:multi";
        links.put(rel, linkArray);
    ...
    public void testGetFirstLinkMultipleLinksNoneMatch() {
        ...
        ObjectNode link2 = nodeFactory.objectNode();
        link1.put("href", "/first-item");
        link1.put("name", "first-item-name");
        link2.put("href", "/second-item");
        link2.put("name", "second-item-name");
        linkArray.add(link1);
        linkArray.add(link2);

        HalJsonResource resource = new HalJsonResource(root);

        resource.getFirstMatchingLink("bb:multi", "doesn't match anything");

    }

    @Test
    public void testGetFirstLinkSingleAndMultipleLinks() {
        ArrayNode linkArray = nodeFactory.arrayNode();
        ObjectNode link1 = nodeFactory.objectNode();
        ObjectNode link2 = nodeFactory.objectNode();
        ObjectNode link3 = nodeFactory.objectNode();
        ObjectNode link4 = nodeFactory.objectNode();
        ObjectNode link5 = nodeFactory.objectNode();
        link1.put("href", "/first-item");
        link1.put("name", "first-item-name");
        link2.put("href", "/second-item");
        link2.put("name", "second-item-name");
        link3.put("href", "/third-item");
        link3.put("name", "third-item-name");
        link4.put("href", "/fourth-item");
        link4.put("name", "");
        link5.put("href", "/fifth-item");
        ...
        ObjectNode singleLink = nodeFactory.objectNode();
        singleLink.put("href", "/singleItem");
        singleLink.put("name", "single-item-name");
        links.put("bb:single", singleLink);
        ...
        HyperLink result = resource.getFirstMatchingLink("bb:multi", "*");
        assertEquals("bb:multi", result.getRel());


        result = resource.getFirstMatchingLink("bb:multi", "dog", "*");
        assertEquals("bb:multi", result.getRel());

        result = resource.getFirstMatchingLink("bb:multi", "third-item-name", "second-item");
        assertEquals("bb:multi", result.getRel());
        assertEquals("third-item-name", result.getName());

        result = resource.getFirstMatchingLink("bb:multi", null, "third-item-name", "second-item");
        assertEquals("bb:multi", result.getRel());
        ...
        result = resource.getFirstMatchingLink("bb:single", "third-item-name", "single-item-name");
        assertEquals("bb:single", result.getRel());
        assertEquals("single-item-name", result.getName());

        result = resource.getFirstMatchingLink("bb:single", "third-item-name", "*");
        assertEquals("bb:single", result.getRel());
        assertEquals("single-item-name", result.getName());
